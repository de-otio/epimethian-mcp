...
```markdown
[Page Title](https://example.atlassian.net/wiki/spaces/DEV/pages/875954196/EX-1234+Overview)
```
...
```markdown
[Overview](confluence://DEV/EX-1234 Overview & Motivation)
```

Result: `<ac:link><ri:page ri:content-title="EX-1234 Overview &amp; Motivation" ri:space-key="DEV"/>...</ac:link>`. Use this when the page ID is unknown.
