...
- Real-world page samples from sibling MCP servers' `generate_confluence_page` output and from existing `epimethian-mcp/doc/design/investigations/*.md` files used as round-trip fixtures.
